...
export class LoadTestScenarios {
    static async runQuickTest(serverUrl, authToken) {
    ...
    static async runMediumTest(serverUrl, authToken) {
    ...
    static async runStressTest(serverUrl, authToken) {
    ...
    static async runProgressiveTest(serverUrl, authToken) {
